...
#endif
#define LCD_EN(a)	(!a ? (P2OUT&=~0X10) : (P2OUT|=0X10)) // P2.5 is lcd enable pin
#define LCD_EN_DIR(a)	(!a ? (P2DIR&=~0X10) : (P2DIR|=0X10)) // P2.5 pin direction

#define LCD_RS(a)	(!a ? (P2OUT&=~0X20) : (P2OUT|=0X20)) // P2.6 is lcd RS pin
#define LCD_RS_DIR(a)	(!a ? (P2DIR&=~0X20) : (P2DIR|=0X20)) // P2.6 pin direction
  
#define LCD_RW(a)	(!a ? (P2OUT&=~0X40) : (P2OUT|=0X40)) // P2.7 is lcd RW pin
#define LCD_RW_DIR(a)	(!a ? (P2DIR&=~0X40) : (P2DIR|=0X40)) // P2.7 pin direction
...
extern void sysConfigState7(void);
